...
if __name__ == '__main__':
    ...
    root        = '/Users/sinaraoufi/Downloads/asiaWest'                 # path to your copy of SEN12MS-CR-TS
    ...
    dataloader  = torch.utils.data.DataLoader(sen12mscrts, batch_size=1, shuffle=False, num_workers=1)
